...
.method private static createMultiResolutionOutputConfigurationCompats(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v9, v8, v7}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m(IILjava/lang/String;)Landroid/hardware/camera2/params/MultiResolutionStreamInfo;
    ...
    .line 1101
    :cond_3
    invoke-static {v3, v6}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/Collection;I)Ljava/util/List;
    ...
    .line 1108
    invoke-static {v6, v7}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m(Landroid/hardware/camera2/params/OutputConfiguration;Landroid/view/Surface;)V
...
.method issuePendingCaptureRequest()V
    ...
    new-instance v1, Landroidx/camera/camera2/internal/CaptureSession$$ExternalSyntheticLambda7;

    invoke-direct {v1, p0}, Landroidx/camera/camera2/internal/CaptureSession$$ExternalSyntheticLambda7;-><init>(Landroidx/camera/camera2/internal/CaptureSession;)V
...
.method issueRepeatingCaptureRequests(Landroidx/camera/core/impl/SessionConfig;)I
    ...
    invoke-interface {v0, p1, v4}, Landroidx/camera/camera2/internal/SynchronizedCaptureSession;->setRepeatingBurstRequests(Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)I
    ...
    invoke-interface {p1, v0, v4}, Landroidx/camera/camera2/internal/SynchronizedCaptureSession;->setSingleRepeatingRequest(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)I
...
.method public open(Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/SynchronizedCaptureSession$Opener;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    new-instance v0, Landroidx/camera/camera2/internal/CaptureSession$$ExternalSyntheticLambda6;

    invoke-direct {v0, p0, p1, p2}, Landroidx/camera/camera2/internal/CaptureSession$$ExternalSyntheticLambda6;-><init>(Landroidx/camera/camera2/internal/CaptureSession;Landroidx/camera/core/impl/SessionConfig;Landroid/hardware/camera2/CameraDevice;)V

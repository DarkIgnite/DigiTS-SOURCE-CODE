...
.method public static addDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    invoke-static {v3}, Landroidx/core/os/Profiling$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
...
.method public static createShortcutResultIntent(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Landroid/content/Intent;
    ...
    invoke-static {p0}, Landroidx/core/os/Profiling$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
...
.method public static disableShortcuts(Landroid/content/Context;Ljava/util/List;Ljava/lang/CharSequence;)V
    ...
    invoke-static {v0}, Landroidx/core/os/Profiling$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
...
.method public static enableShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {v2}, Landroidx/core/os/Profiling$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;

    move-result-object v2

    invoke-static {v2, v1}, Landroidx/core/os/Profiling$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
...
.method public static getIconMaxWidth(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Landroidx/core/os/Profiling$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/content/pm/ShortcutManager;)I
...
.method public static pushDynamicShortcut(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Z
    ...
    invoke-static {v3, v4}, Landroidx/core/os/Profiling$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
    ...
    invoke-static {v3, v4}, Landroidx/core/os/Profiling$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/content/pm/ShortcutManager;Ljava/util/List;)Z
...
.method public static removeLongLivedShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {v0, p1}, Landroidx/core/os/Profiling$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
...
.method public static updateShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    invoke-static {v3, v2}, Landroidx/core/os/Profiling$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/content/pm/ShortcutManager;Ljava/util/List;)Z

...
.method private createImageReader29()Landroid/media/ImageReader;
    ...
    invoke-static/range {v0 .. v5}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m(IIIIJ)Landroid/media/ImageReader;
...
.method private createImageReader33()Landroid/media/ImageReader;
    ...
    .line 904
    invoke-static {}, Landroidx/webkit/internal/ApiHelperForP$$ExternalSyntheticApiModelOutline1;->m$1()V

    iget v0, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->requestedWidth:I

    iget v1, p0, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;->requestedHeight:I

    invoke-static {v0, v1}, Landroidx/webkit/internal/ApiHelperForP$$ExternalSyntheticApiModelOutline1;->m(II)Landroid/media/ImageReader$Builder;
    ...
    .line 906
    invoke-static {v0, v1}, Landroidx/webkit/internal/ApiHelperForP$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/ImageReader$Builder;I)Landroid/media/ImageReader$Builder;

    const/16 v1, 0x22

    .line 913
    invoke-static {v0, v1}, Landroidx/webkit/internal/ApiHelperForP$$ExternalSyntheticApiModelOutline1;->m$1(Landroid/media/ImageReader$Builder;I)Landroid/media/ImageReader$Builder;

    const-wide/16 v1, 0x100

    .line 915
    invoke-static {v0, v1, v2}, Landroidx/webkit/internal/ApiHelperForP$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/ImageReader$Builder;J)Landroid/media/ImageReader$Builder;

    .line 916
    invoke-static {v0}, Landroidx/webkit/internal/ApiHelperForP$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/ImageReader$Builder;)Landroid/media/ImageReader;
...
.method private waitOnFence(Landroid/media/Image;)V
    ...
    .line 751
    :try_start_0
    invoke-static {p1}, Landroidx/webkit/internal/ApiHelperForP$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/Image;)Landroid/hardware/SyncFence;

    move-result-object p1

    .line 752
    invoke-static {p1}, Landroidx/webkit/internal/ApiHelperForP$$ExternalSyntheticApiModelOutline1;->m(Landroid/hardware/SyncFence;)Z
    :try_end_0
...
.method dequeueImage()Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer$PerImage;
    ...
    new-instance v1, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer$$ExternalSyntheticLambda8;

    invoke-direct {v1, p0}, Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer$$ExternalSyntheticLambda8;-><init>(Lio/flutter/embedding/engine/renderer/FlutterRenderer$ImageReaderSurfaceProducer;)V
